...
continuingstudents = pd.read_excel("../controller/uploads/continuing.xlsx",\
                                index_col=0, sheet_name="continuing students")
freshmen = pd.read_excel("../controller/uploads/freshers.xlsx", \
                                index_col=0, sheet_name="freshers")
